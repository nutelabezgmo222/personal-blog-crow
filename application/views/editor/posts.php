        ...
        <tbody id="list">
          <?php foreach ($list as $val): ?>
              <tr>
                  ...
                  <td><a href="/blogg/editor/edit/<?php echo $val['id']; ?>" class="edit_btn">Редактировать</a></td>
                  <td><a href="/blogg/editor/delete/<?php echo $val['id']; ?>" class="delete_btn">Удалить</a></td>
              </tr>
          <?php endforeach; ?>
        </tbody>
      </table>
